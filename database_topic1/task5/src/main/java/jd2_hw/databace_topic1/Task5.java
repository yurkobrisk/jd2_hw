package jd2_hw.databace_topic1;
...
//            statement.executeUpdate(deleteQuery);
            ...
            // Прекомпиляция запросов
            String tempQuery = "SELECT * FROM listexpenses.expenses WHERE value > ?";
            PreparedStatement pStatement = connection.prepareStatement(tempQuery);
